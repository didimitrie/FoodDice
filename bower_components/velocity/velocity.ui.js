        ...
        { 
            ...
            "callout.dshake": {
                ...
                calls: [ 
                    [ {scale: 0.9}, 0.1],
                    [ { translateX: -10}, 0.1 ],
                    [ { translateX: 10}, 0.1, 100 ],
                    [ { translateX: 0 , scale: 1}, 0.1 ]
                ]
            },
            /* Animate.css */
            "callout.flash": {
            ...
            "callout.tada": {
                ...
                calls: [ 
                    [ { scaleX: 0.9, scaleY: 0.9, rotateZ: -23 }, 0.10 ],
                    [ { scaleX: 1.1, scaleY: 1.1, rotateZ: 23 }, 0.10 ],
                    [ { scaleX: 1.1, scaleY: 1.1, rotateZ: -23 }, 0.10, 3 ],
            ...
            "transition.dflipXIn": {
                ...
                reset: { transformPerspective: 0, scale: 1}
            },
            /* Support: Loses rotation in IE9/Android 2.3. (Fades only.) */
            "transition.flipXOut": {
